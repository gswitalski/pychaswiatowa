-- Migration: Create admin users page RPC
-- Description: Provides paginated and sortable admin users list for GET /admin/users
...
begin
    ...
    order by
        ...
        -- last_sign_in_at (always nulls last)
