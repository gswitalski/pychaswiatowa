-- migration: update recipe_details view for normalized ingredients status
-- description: updates recipe_details view to include normalized_ingredients_status and normalized_ingredients_updated_at columns
-- views affected: recipe_details
-- dependencies: recipes (with normalized_ingredients_status and normalized_ingredients_updated_at fields)

-- drop existing view
drop view if exists public.recipe_details;

-- recreate recipe_details view with normalized ingredients fields
...
select
    ...
    -- normalized ingredients fields
    r.normalized_ingredients_status,
    r.normalized_ingredients_updated_at,
...
comment on view public.recipe_details is
    'comprehensive view of recipes with aggregated tags, collections, visibility, servings, time fields, termorobot flag, classification fields (diet_type, cuisine, difficulty, is_grill), tips, normalized ingredients status, and search_vector for full-text search';
