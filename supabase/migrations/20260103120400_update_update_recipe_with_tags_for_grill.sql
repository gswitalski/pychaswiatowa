-- migration: update update_recipe_with_tags for grill flag
-- description: adds is_grill parameter to update_recipe_with_tags function
-- functions affected: update_recipe_with_tags
-- note: uses update flag to distinguish between "not provided" and "set to value"

-- update update_recipe_with_tags function to include is_grill parameter
create or replace function public.update_recipe_with_tags(
    ...
    p_is_grill boolean default null,                    -- NEW: grill flag parameter
    p_update_is_grill boolean default false             -- NEW: update grill flag
)
returns bigint
language plpgsql
security definer
...
begin
    ...
    set
        ...
        is_grill = case                                 -- NEW: conditional grill flag update
...
comment on function public.update_recipe_with_tags(bigint, uuid, text, text, bigint, text, text, text[], boolean, recipe_visibility, text, boolean, smallint, boolean, boolean, boolean, smallint, boolean, smallint, boolean, recipe_diet_type, boolean, recipe_cuisine, boolean, recipe_difficulty, boolean, boolean, boolean) is
    'Updates an existing recipe with associated tags, visibility, image path, category, servings, termorobot flag, time fields, and classification fields (diet_type, cuisine, difficulty, is_grill) in a single atomic transaction. Returns the updated recipe ID.';

-- grant execute permission to authenticated users
grant execute on function public.update_recipe_with_tags(bigint, uuid, text, text, bigint, text, text, text[], boolean, recipe_visibility, text, boolean, smallint, boolean, boolean, boolean, smallint, boolean, smallint, boolean, recipe_diet_type, boolean, recipe_cuisine, boolean, recipe_difficulty, boolean, boolean, boolean) to authenticated;
