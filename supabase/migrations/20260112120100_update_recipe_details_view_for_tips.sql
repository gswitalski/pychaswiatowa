-- migration: update recipe_details view for tips column
-- description: updates recipe_details view to include tips column
-- views affected: recipe_details
-- dependencies: recipes (with tips field)

-- drop existing view
drop view if exists public.recipe_details;

-- recreate recipe_details view with tips column
...
comment on view public.recipe_details is
    'comprehensive view of recipes with aggregated tags, collections, visibility, servings, time fields, termorobot flag, classification fields (diet_type, cuisine, difficulty, is_grill), tips, and search_vector for full-text search';
