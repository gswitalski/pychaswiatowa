-- migration: update recipe_details view for grill flag
-- description: updates recipe_details view to include is_grill column
...
-- recreate recipe_details view with grill flag
...
comment on view public.recipe_details is
    'comprehensive view of recipes with aggregated tags, collections, visibility, servings, time fields, termorobot flag, classification fields (diet_type, cuisine, difficulty, is_grill), and search_vector for full-text search';
