-- migration: update create_recipe_with_tags function for classification fields
-- description: adds diet_type, cuisine, and difficulty parameters to create_recipe_with_tags function
-- functions affected: create_recipe_with_tags
-- note: all classification parameters are optional and nullable

-- update create_recipe_with_tags function to include classification parameters
...
begin
    ...
    insert into public.recipes (
        ...
        prep_time_minutes,
        total_time_minutes,
        diet_type,          -- NEW: diet type column
        cuisine,            -- NEW: cuisine column
        difficulty          -- NEW: difficulty column
    ) values (
        p_user_id,
        p_name,
        p_description,
        ...
        p_diet_type,        -- NEW: diet type value
        p_cuisine,          -- NEW: cuisine value
        p_difficulty        -- NEW: difficulty value
    )
...
comment on function public.create_recipe_with_tags(uuid, text, text, bigint, text, text, text[], recipe_visibility, smallint, boolean, smallint, smallint, recipe_diet_type, recipe_cuisine, recipe_difficulty) is
    'Creates a new recipe with associated tags, visibility setting, servings, termorobot flag, time fields, and classification fields (diet_type, cuisine, difficulty) in a single atomic transaction. Returns the new recipe ID.';

-- grant execute permission to authenticated users
grant execute on function public.create_recipe_with_tags(uuid, text, text, bigint, text, text, text[], recipe_visibility, smallint, boolean, smallint, smallint, recipe_diet_type, recipe_cuisine, recipe_difficulty) to authenticated;
