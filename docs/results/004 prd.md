...
-   *Opis:* Jako nowy użytkownik, chcę móc stworzyć konto w aplikacji, podając swój adres e-mail i hasło, abym mógł bezpiecznie przechowywać swoje prywatne przepisy.
-   *Kryteria akceptacji:*
    ...
    4.  Po pomyślnej rejestracji, użytkownik jest automatycznie zalogowany i przekierowany na stronę główną (listę przepisów).
    5.  W przypadku, gdy konto o podanym adresie e-mail już istnieje, wyświetlany jest odpowiedni komunikat błędu.
